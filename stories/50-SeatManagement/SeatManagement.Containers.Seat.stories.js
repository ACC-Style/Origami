...
export default {
	...
	component: { SeatList ,SingleSeat, SingleSeatLoading},
	parameters: {
...
export const SeatData =  [{
  ...
  export const SeatFilled = () => {
	return {
		components:{SingleSeat},
		template: `<SingleSeat v-bind="seat"/>`,
	  data() {
		  return {
			  seat:SeatData[0],
		  }
